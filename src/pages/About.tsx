            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mb-20">
                <div>
                    ...
                    <p className="font-body text-xl md:text-2xl leading-relaxed max-w-lg">
                        I combine raw brutalist aesthetics with refined interaction design to create web experiences that are not just seen, but felt.
                    </p>
                </div>
                ...
                <div className="flex flex-col justify-end gap-10">
                    <div className="border-t border-current pt-4">
                        ...
                        <p className="font-body opacity-70">Rejecting the generic. Embracing the bold. I believe the web has become too safe, too rounded, too soft. I bring back the edge.</p>
                    </div>
                    <div className="border-t border-current pt-4">
